...
public class EoGCoinDropAnimationSfx : MonoBehaviour, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        scaleBack.Play();
        GlobalAudioScript.Instance.playSfxSound3("metal_drop");
    }
}